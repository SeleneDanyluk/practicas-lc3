...
const showMovies = (titlesArray) => {
    const cardContainer = document.getElementById("card");
    
    const movie = titlesArray.map(title => `<li class="list-group-item">${title}</li>`);
    
    const html = `<ol class="list-group list-group-numbered">${movie.join('')}</ol>`;
